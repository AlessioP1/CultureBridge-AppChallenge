...
const Resource4 = ({ navigation }) => {
  ...
  const askMeAnything = 'Ask me anything - I am your employment assistant. Information may be a bit outdated.';
...
<View style={styles.sectionContainer}>
                <Text style={styles.sectionHeader}>Employment Resources</Text>
                <Dropdown 
                    title="Employment Title 1"
                    icon={require('../assets/creditScore.jpg')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• Emp 1.1</Text>
                            <Text style={styles.bulletPoint}>• Emp 1.2</Text>
                            <Text style={styles.bulletPoint}>• Emp 1.3</Text>
                        </View>
                    }
                />
                <Dropdown 
                    title="Employment Title 2"
                    icon={require('../assets/creditCard.jpg')} // Adjust the icon path
                    content={
                        <View>
                             <Text style={styles.bulletPoint}>• Emp 1.1</Text>
                            <Text style={styles.bulletPoint}>• Emp 2.2</Text>
                            <Text style={styles.bulletPoint}>• Emp 2.3</Text>
                        </View>
                    }
                />
                <Dropdown 
                    title="Employment Title 3"
                    icon={require('../assets/budget.png')} // Adjust the icon path
                    content={
                        <View>
                               <Text style={styles.bulletPoint}>• Emp 3.1</Text>
                            <Text style={styles.bulletPoint}>• Emp 3.2</Text>
                            <Text style={styles.bulletPoint}>• Emp 3.3</Text>
                        </View>
                    }
                />
