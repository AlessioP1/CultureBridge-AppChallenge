...
const Resource1 = ({ navigation }) => {
  ...
  const askMeAnything = 'Ask me anything - I am your local community assistant. Information may be a bit outdated.';
...
<View style={styles.sectionContainer}>
                <Text style={styles.sectionHeader}>Local Community Resources</Text>
                <Dropdown 
                    title="Local Comm Title 1"
                    icon={require('../assets/creditScore.jpg')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• LC 1.1</Text>
                            <Text style={styles.bulletPoint}>• LC 1.2</Text>
                            <Text style={styles.bulletPoint}>• LC 1.3</Text>
                        </View>
                    }
                />
                <Dropdown 
                    title="Local Comm Title 2"
                    icon={require('../assets/creditCard.jpg')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• LC 2.1</Text>
                            <Text style={styles.bulletPoint}>• LC 2.2</Text>
                            <Text style={styles.bulletPoint}>• LC 2.3</Text>
                        </View>
                    }
                />
                <Dropdown 
                    title="Local Comm Title 3"
                    icon={require('../assets/budget.png')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• LC 3.1</Text>
                            <Text style={styles.bulletPoint}>• LC 3.2</Text>
                            <Text style={styles.bulletPoint}>• LC 3.3</Text>
                        </View>
                    }
                />
