...
const Resource6 = ({ navigation }) => {
  const [posts, setPosts] = useState([]);
  const isFocused = useIsFocused();
  const resourceId= 'resource6';
  const chatRole = 'You are a language advisor or teacher';
  const imageLocation ='../assets/Language2.png';
  const headerTextForPage = 'Language Resources';
  const askMeAnything = 'Ask me anything - I am your language assistant. Information may be a bit outdated.';
...
<View style={styles.sectionContainer}>
                <Text style={styles.sectionHeader}>Language Resources</Text>
                <Dropdown 
                    title="Language Title 1"
                    icon={require('../assets/creditScore.jpg')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• Lang 1.1</Text>
                            <Text style={styles.bulletPoint}>• Lang 1.2</Text>
                            <Text style={styles.bulletPoint}>• Lang 1.3</Text>
                        </View>
                    }
                />
                <Dropdown 
                    title="Language Title 2"
                    icon={require('../assets/creditCard.jpg')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• Lang 2.1</Text>
                            <Text style={styles.bulletPoint}>• Lang 2.2</Text>
                            <Text style={styles.bulletPoint}>• Lang 2.3</Text>
                        </View>
                    }
                />
                <Dropdown 
                    title="Language Title 3"
                    icon={require('../assets/budget.png')} // Adjust the icon path
                    content={
                        <View>
                            <Text style={styles.bulletPoint}>• Lang 3.1</Text>
                            <Text style={styles.bulletPoint}>• Lang 3.2</Text>
                            <Text style={styles.bulletPoint}>• Lang 3.3</Text>
                        </View>
                    }
                />
