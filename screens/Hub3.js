...
const Hub3 = () => {
  ...
  useEffect(() => {
    const unsubscribe = db.collection('hubs').doc('Hub3').collection('posts').onSnapshot(snapshot => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.contentText}>Welcome to Hub 3! Here you can find various resources and information.</Text>
      </View>
